// FORK: Team Workflow prompt text lives in the fork provider module.
import {
  buildTeamInstructions,
  type RuntimeInstructionTeam,
} from "../fork/provider/TeamRuntimeInstructions.ts";
export type { RuntimeInstructionTeam } from "../fork/provider/TeamRuntimeInstructions.ts";
